...
public class JDBC {
	...
	public static void main(String[] args) {
        ...
        try{
            option = Integer.parseInt(ch);
         } 
         catch (NumberFormatException exception){
            System.out.println("Wrong input integer only from 1-11");
            continue;
         }
        switch(option) {
        case 1:
...
//                System.out.println("SupplierID |\t ProductName |\t unitprice");
...
//                    }
        ...
        case 11:System.out.println("Exiting......");
    		System.exit(0);
    		default:
    			System.out.print("Wrong input integer only from 1-11");
